...
inline static vec2 sign_select(vec2 const& val, vec2 const& neg, vec2 const& pos)
{
...
inline static vec4 sign_select(vec4 const& val, vec4 const& neg, vec4 const& pos)
{
