 ...
 */
template<typename MATRIX>
void addRigidityMatrix(MATRIX& mat, const size_t inx, const size_t cnt, const real R1)
{
    assert_true( cnt > 2 );
...
template<typename MATRIX>
void addRigidityBlockMatrix(MATRIX& mat, const size_t inx, const size_t cnt, const real R1)
{
    assert_true( cnt > 2 );
 ...
 */
void addRigidityUpper(real* mat, size_t ldd, size_t cnt, const real R1)
{
    assert_true( cnt > 2 );
...
/**
 ...
 Only terms above the diagonal and corresponding to the first subspace are set
 */
void addRigidityLower(real* mat, size_t ldd, size_t cnt, const real R1)
{
    assert_true( cnt > 2 );
