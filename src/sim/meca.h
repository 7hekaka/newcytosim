...
public:
    ...
    void interTorque(Interpolation const&, Interpolation const&, real cosinus, real sinus, real weight);
    ...
    void interCoulomb(Mecapoint const&, Mecapoint const&, real weight);
